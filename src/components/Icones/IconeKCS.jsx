...
export default function IconeKCS() {
  const style = {
    height: '20px',
    width: '20px',
    marginLeft: '5px',
  ...
  return (
    <div className="icone" style={style} >
      <svg version="1.1" id="Layer_1" x="0px" y="0px"
        viewBox="0 0 32 32"  >
        <g>
          <circle fill="#0093DD" cx="16" cy="16" r="16" />
          <path fill="#FFFFFF" d="M13.5,16l5.2,5.3L22,18c0.6-0.6,1.5-0.6,2,0c0,0,0,0,0,0c0.6,0.6,0.6,1.6,0,2.2l-4.3,4.4
